    ...
    <div class="holochainCoGov">
        ...
        <p class="holochainCoGov__body">
            ...
            <span style="display flex;">
                <a href="https://holochain.org/" target="blank" class="addlink" style="margin-right: 1rem;">Holochain</a>
                <a href="https://holo.host/" target="blank" class="addlink" style="margin-left: 1rem; ">Holo</a>
            </span>
            <br>
            <br>
        </p>
            <iframe class="holochainCoGov__video" src="https://www.youtube.com/embed/2FJL3ibnZlY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>        
