...
<br><br>
The <a href="/vision" target="_blank" class="addlink">core principles</a> that have been identlified in creating <a href="/protocol.love">protocol.love</a> create a communications framework that avoid these pitfalls. While digital tools are also in the works, during this critical time, we are very interested in using the operational principles “on paper”, so to speak. The CoGov staff would love nothing more than to work with your organization now to design a <a href="https://docs.google.com/document/d/1Rh02JzKhQ5sA6V500cQm74kb-jd4VcS8bskDDUsBpQA" target="_blank" class="addlink">Collective Foundational Document</a> that creates fertile ground for your organization to thrive. We at CoGov believe that “slow is the new fast”, and while there may be a tendency to want to jump into “doing-ness”, we believe in establishing practices of “being-ness” first. And our experience shows that in the end, things ultimately get done expontentially faster when the proper human energetic coherence patterns have been established early on.
<br><br>
