        ...
        <div class="homeCollaborators__collaborators">
            <div class="homeCollaborators__collaborator">
                <a class="homeCollaborators__collaborator" href="https://www.metacurrency.org" target="blank">            
                    <img src="/src/assets/images/cogov__metacurrency.png" alt="" class="homeCollaborators__collaborator--logo">
            ...
            <div class="homeCollaborators__collaborator">
                <a class="homeCollaborators__collaborator" href="https://www.onenation.party/1" target="blank">            
                    <img src="/src/assets/images/cogov__onenation.png" alt="" class="homeCollaborators__collaborator--logo">
            ...
            <div class="homeCollaborators__collaborator" >
                <a class="homeCollaborators__collaborator" href="https://lightleadership.com/" target="blank">            
                    <img src="/src/assets/images/cogov__lightleadership.png" alt="" class="homeCollaborators__collaborator--logo">
            ...
            <div class="homeCollaborators__collaborator" >
                <a class="homeCollaborators__collaborator" href="https://superluminal.is/" target="blank">            
                    <img src="/src/assets/images/cogov__superluminal-systems.png" alt="" class="homeCollaborators__collaborator--logo">
            ...
            <div class="homeCollaborators__collaborator" >
                <a class="homeCollaborators__collaborator" href="https://core.network/" target="blank">            
                    <img src="/src/assets/images/cogov__core-network.png" alt="" class="homeCollaborators__collaborator--logo">
            ...
            <div class="homeCollaborators__collaborator">
                <a class="homeCollaborators__collaborator" href="https://www.unify.org/" target="blank">            
                    <img src="/src/assets/images/cogov__unify.png" alt="" class="homeCollaborators__collaborator--logo">
            ...
            <div class="homeCollaborators__collaborator">
                <a class="homeCollaborators__collaborator" href="https://social-evolution.com/" target="blank">            
                    <img src="/src/assets/images/cogov__socialevolution.png" alt="" class="homeCollaborators__collaborator--logo">
            ...
            <div class="homeCollaborators__collaborator">
                <a class="homeCollaborators__collaborator" href="https://freedomculture.org/" target="blank">            
                    <img src="/src/assets/images/cogov__freedomculture.png" alt="" class="homeCollaborators__collaborator--logo">
            ...
            <div class="homeCollaborators__collaborator">
                <a class="homeCollaborators__collaborator" href="http://www.fwii.net/" target="blank">            
                    <img src="/src/assets/images/cogov__fourworlds.png" alt="" class="homeCollaborators__collaborator--logo">
            ...
            <div class="homeCollaborators__collaborator">
                <a class="homeCollaborators__collaborator" href="http://www.iwg.life/s7foundation/" target="blank">            
                    <img src="/src/assets/images/cogov__s7.png" alt="" class="homeCollaborators__collaborator--logo">
            ...
            <div class="homeCollaborators__collaborator">
                <a class="homeCollaborators__collaborator" href="https://junto.foundation/" target="blank">            
                    <img src="/src/assets/images/cogov__junto-logo.png" alt="" class="homeCollaborators__collaborator--logo">
            ...
            <div class="homeCollaborators__collaborator">
                <a class="homeCollaborators__collaborator" href="https://www.futureproper.world/" target="blank">            
                    <img src="/src/assets/images/cogov__future-proper-logo.png" alt="" class="homeCollaborators__collaborator--logo">
